...
| 2026-05-20 | 2.0.1 | DB schema: `session_operations.question_correct_answer` BIGINT→JSON, `user_answer` INT→JSON, `operation_type VARCHAR(50)` column added (NULL for Quick Calculate). No logic changes. | 🔄 In Progress |
